...
const About = () => {
  return (
    <div className="about-container">
      <h1>About Fitness Island</h1>
      <div className="about-content">
        <div className="about-section">
          <h2>Our Mission</h2>
          <p>We help you track your fitness journey with precision and motivation. Whether you're just starting or an experienced athlete, Fitness Island is here to help you reach your goals.</p>
        </div>
        <div className="about-section">
          <h2>What We Offer</h2>
          <ul>
        ...
        <div className="about-section">
          <h2>Why Choose Us</h2>
          <p>Fitness Island provides a simple yet powerful way to monitor your fitness progress. Our platform is designed to help you achieve your health goals through data-driven insights and personalized tracking. Whether your goal is weight loss, muscle gain, or endurance improvement, Fitness Island provides a tailored experience for you.</p>
        </div>
        <div className="about-section">
          <h2>Our Approach</h2>
          <p>At Fitness Island, we prioritize your fitness journey with a holistic approach. We integrate personalized coaching, scientific tracking methods, and motivational tools to help you stay on track and see real results.</p>
        </div>
        <div className="about-section">
          <h2>Our Team</h2>
